                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Receivable
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="ml-2 container-fluid">
                    ...
                    <div class="row">
                        {{-- <div class="mr-auto col">
                            <form action="{{ url('receivable_search') }}" method="get">
                                <div class="row">
                    ...
                    <div class="mt-3 col-md-12">
                        <div class="card ">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h3 class="card-title">Receivable</h3>
                                    ...
                                    <div id="branchDropdown" class="dropdown ml-auto"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            @if (auth()->user()->is_admin == '1')
                                                <a href="{{ url('receivable') }}" class="dropdown-item">All </a>
                                                @foreach ($branchs as $drop)
                                                    <a class="dropdown-item"
                                                        href="{{ route('receivable', $drop->id) }}">{{ $drop->name }}</a>
                                                @endforeach
                                            @else
                                                @php
