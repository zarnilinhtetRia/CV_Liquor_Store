                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($transaction as $tran)
                                                <tr>
                                                    ...
                                                    @php
                                                        $totalOpeningIn += $accountDepositSums[$tran->id]['depositprevious'];
                                                        $totalOpeningOut += $accountDepositSums[$tran->id]['expenseprevious'];
                                                        $totalCurrentIn += $accountDepositSums[$tran->id]['depositcurrent'];
                                                        $totalCurrentOut += $accountDepositSums[$tran->id]['expensecurrent'];
                                                        $totalIn += $accountDepositSums[$tran->id]['depositprevious'] + $accountDepositSums[$tran->id]['depositcurrent'];
                                                        $totalOut += $accountDepositSums[$tran->id]['expenseprevious'] + $accountDepositSums[$tran->id]['expensecurrent'];
                                                    @endphp
                                                </tr>
                                            @endforeach
                                        </tbody>
