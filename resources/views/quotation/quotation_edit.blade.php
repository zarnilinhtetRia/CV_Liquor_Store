                ...
                <div class="my-3 mt-4 row">
                    <div class="col-md-3">
                        ...
                        <input type="text" id="quote_no" class="form-control" name="quote_no"
                            value="{{ $quotation->quote_no }}" required>
                    </div>
                    <div class="col-md-3">
                                            ...
                                            <tbody>
                                                <tr class="item_header bg-gradient-directional-blue white">
                                                    <td class="text-center"><input type='text'
                                                            name='customer_name' id="name" class="form-control"
                                                    ...
                                                    <td class="text-center" style="display: none;"><input
                                                            ...
                                                            class="form-control" value="{{ $quotation->type }}"></td>
                                                ...
                                                @foreach ($sell as $key => $sell)
                                                    <tr>
                                                        ...
                                                        <td><select name="product_category[]" id="product_category-0"
                                                                ...
                                                                <option value="{{ $sell->product_category }}">
                                                                    {{ $sell->product_category }}</option>
                                                        ...
                                                        <td><input type="text" class="form-control item_unit"
                                                                ...
                                                                value="{{ $sell->unit }}"></td>
                                                        <!-- <td class="wholesale_td"><input type="text" class="form-control price" name="product_price[]"
                                                                id="price-0" autocomplete="off"
                                                                value="{{ $sell->product_price }}"> </td>-->
                                                        {{-- <td class="foc_td">
                                                        ...
                                                        <td class="retail_td"><input type="number"
                                                        ...
                                                        <td>
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    value="{{ $sell->discount }}" autocomplete="off">
                                        ...
                                        <table class="mt-3">
                                            <tbody id="showitem">
                                                ...
                                                <tr class="" hidden>
                                                    ...
                                                    <td align="left" colspan="2" class="col-md-2">
                                                        <select name="currency_method" id="currency_method"
                                                            class="form-control">
                                                            <option value="MMK"
                                                                @if ($quotation->currency_method == 'MMK') selected @endif>MMK
                                                            </option>
                                                            <option value="USD"
                                                                @if ($quotation->currency_method == 'USD') selected @endif>USD
                                                            </option>
                                                            <!-- <option value="YUAN"
                                                                @if ($quotation->currency_method == 'YUAN') selected @endif>YUAN
                                                            </option> -->
                                                        </select>
                                                    </td>
                                                </tr>
                                                ...
                                                @php
                                                    if ($quotation->currency_method == 'MMK') {
                                                        ...
                                                        $overall_dis = $quotation->overall_discount_mmk;
                                                        $item_discount = $item_dis;
                                                        $final_total = $quotation->total;
                                                    } else {
                                                        $overall_dis = $quotation->overall_discount_mmk;
                                            ...
                                            <tr class="sub_c" style="display: table-row;">
                                                ...
                                                <td align="left" colspan="2"><input type="number"
                                                        ...
                                                        onchange="paidFunction()" value="{{ $quotation->deposit }}"
                                                        required>
                                            ...
                                            <tr class="sub_c" style="display: table-row;">
                                                ...
                                                <td align="left" colspan="2"><input type="text"
                                                        ...
                                                        value="{{ $quotation->remain_balance }}">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).ready(function() {
                ...
                let payment_count = @json($payment_methods).length + 1;
