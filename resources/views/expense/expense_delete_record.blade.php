            ...
            <section class="content">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="mb-2 row">
                            <div class="col-sm-6">
                                <h1>Expense Delete Record</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item">Expense Delete Record
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="mt-3 col-md-12">
                    <div class="card ">
                        <div class="d-flex card-header">
                            <h3 class="card-title">Expense Delete Record Table</h3>
                            <a href="{{ url('expense') }}" class="btn btn-danger ml-auto">Back</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($expenses as $key => $expense)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{{ $expense->name }}</td>
                                            <td>{{ $expense->expenseCategory ? $expense->expenseCategory->name : '' }}
                                            </td>
                                            ...
                                            <td>
                                                <a href="{{ url('restore_expense', $expense->id) }}"
