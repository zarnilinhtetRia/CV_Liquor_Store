        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                        ...
                        <div class="mb-2 row">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item">Brand
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="ml-2 container-fluid">
                    ...
                    @if (in_array('Brand Register', $choosePermission) || auth()->user()->is_admin == '1')
                        <div class="row">
                                    ...
                                    @foreach ($brands as $key => $brand)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <!-- @if (in_array('Brand Variation', $choosePermission) || auth()->user()->is_admin == '1')
<a href="{{ url('brand_variations', $brand->id) }}" class="btn btn-success btn-sm"><i
                                                class="fa-solid fa-code-branch"></i> Add Variation</a>
@endif -->
                                                {{ $brand->warehouse->name }}
                                            </td>
                                            <td>
                                                @if (in_array('Brand Edit', $choosePermission) || auth()->user()->is_admin == '1')
                                                    <a href="{{ url('brand_edit', $brand->id) }}"
                                                        class="btn btn-success btn-sm"><i
                                                            class="fa-solid fa-pen-to-square"></i></a>
                                                @endif

                                                @if (in_array('Brand Delete', $choosePermission) || auth()->user()->is_admin == '1')
                                                    <a href="{{ url('brand_delete', $brand->id) }}"
