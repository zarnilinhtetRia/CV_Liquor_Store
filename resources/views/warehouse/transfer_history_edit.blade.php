...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <div class="container-fluid">
            <form action=" {{ url('transfer_history_update', $historys->first()->transfer_no) }}" method="POST">
                @csrf
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                @if (auth()->user()->is_admin == '1')
                                                                    ...
                                                                    @foreach ($warehouses as $warehouse)
                                                                        <option value="{{ $warehouse->id }}"
                                                                            @if ($warehouse->id == $historys->first()->from_location) selected @endif>
                                                        ...
                                                        <div class="frmSearch col-sm-3">
                                                            ...
                                                            <select name="to_location" id="to_location"
                                                                ...
                                                                @foreach ($warehouses as $warehouse)
                                                                    <option value="{{ $warehouse->id }}"
                                                                        @if ($warehouse->id == $historys->first()->to_location) selected @endif>
                                                                        {{ $warehouse->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="frmSearch col-sm-3">
                                                            ...
                                                            <div class="input-group mb-2">
                                                                ...
                                                                <input type="date" name="date" id="date"
                                                                    ...
                                                                    max="<?= date('Y-m-d') ?>"
                                                                    value="{{ $historys->first()->date }}" required>
                                                        ...
                                                        <div class="frmSearch col-sm-3">
                                                            ...
                                                            <div class="input-group mb-2">
                                                                <input type="text" name="transfer_number"
                                                                    ...
                                                                    value="{{ $historys->first()->transfer_no }}"
                                                                    required readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <table class="">
                                            ...
                                            <tbody id="showitem123">
                                                @foreach ($historys as $key => $history)
                                                    <tr>
                                                        <td class="text-center" id="count">{{ $key + 1 }}
                                                        </td>
                                                        <td>
                                                            ...
                                                            <input type="hidden"
                                                                ...
                                                                autocomplete="off"
                                                                value="{{ $history->variation ? $history->variation->product_code : '' }}">
                                                            <input type="hidden"
                                                                class="form-control category typeahead category"
                                                                name="category[]" id="category-0" autocomplete="off"
                                                                value="{{ $history->item ? $history->item->item_category : '' }}">
                                                            <input type="hidden"
                                                                class="form-control brand typeahead brand"
                                                                name="brand[]" id="brand-0" autocomplete="off"
                                                                value="{{ $history->item ? $history->item->brand : '' }}">
                                                            <input type="hidden"
                                                                class="form-control model typeahead model"
                                                                name="model[]" id="model-0" autocomplete="off"
                                                                value="{{ $history->variation ? $history->variation->model : '' }}">
                                                            <input type="hidden"
                                                                class="form-control colour typeahead colour"
                                                                name="colour[]" id="colour-0" autocomplete="off"
                                                                value="{{ $history->variation ? $history->variation->colour : '' }}">
                                                            <input type="hidden"
                                                                class="form-control size typeahead size"
                                                                name="size[]" id="size-0" autocomplete="off"
                                                                value="{{ $history->variation ? $history->variation->size : '' }}">
                                                            <input type="hidden"
                                                                class="form-control seater typeahead seater"
                                                                name="seater[]" id="seater-0" autocomplete="off"
                                                                value="{{ $history->variation ? $history->variation->seater : '' }}">

                                                        </td>
                                                        <td>
                                                            <input type="text"
                                                                class="form-control total_product_qty"
                                                                name="total_product_qty[]" id="total_amount-0"
                                                                autocomplete="off"
                                                                value="{{ $history->variation->item_quantity->warehouse_qty }}"
                                                                readonly>
                                                        </td>
                                                        ...
                                                        <td><input type="text" class="form-control req amnt"
                                                                ...
                                                                name="alert[]" value="{{ $history->quantity }}">
                                                        </td>
        ...
        $(document).ready(function() {
            ...
            function initializeTypeahead(count) {
                ...
                $('#productname-' + count).typeahead({
                    ...
                    afterSelect: function(item) {
                        ...
                        $('#category-' + count).val(item.item_category);
            ...
            $("#addproduct").click(function(e) {
                ...
                let newRow = '<tr>' +
                    ...
                    count +
                    '" autocomplete="off"><input type="hidden" class="form-control  typeahead category" name="category[]" id="category-' +
                    count +
    ...
    <script>
        document.getElementById('from_location').addEventListener('mousedown', function(e) {
            e.preventDefault();
        });

        document.getElementById('to_location').addEventListener('mousedown', function(e) {
            e.preventDefault();
        });
    </script>
