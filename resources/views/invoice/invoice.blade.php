...
<body>
    ...
    <div class="container-fluid" id="content">
        ...
        <form method="post" id="myForm" action="{{ url('invoice_register') }}" enctype="multipart/form-data">
            ...
            <div class="mx-3 row ">
                ...
                <div class="my-1 mt-2 row">
                    <div class="col-md-3">
                        <label for="invoice_no" style="font-weight:bolder">Invoice Number <span
                                class="text-danger">*</span></label>
                        <input type="text" id="invoice_no" class="form-control" name="invoice_no" value=""
                            required>
                    </div>

                    {{-- <div class="col-md-3">
                        <label for="branch_invoice_no" style="font-weight:bolder">Branch Invoice Number</label>
                    ...
                    <div class="mt-4 frmSearch col-md-3">
                        <label for="siteCheckbox" class="form-label fw-bold">{{ trans('Site') }}</label>

                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="siteCheckbox" name="site"
                                value="site" style="transform: scale(1.5);">
                            <label class="form-check-label fs-5 fw-bold" for="siteCheckbox">
                                Enable Site
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="">
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 cmp-pnl" style="display: none;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="price_td">
                                                            <select
                                                                ...
                                                                <option value="promotion_retail_unit">Retail Price
                                                                </option>
                                                        ...
                                                        <td class="d-none">
                                                            <input type="text" class="form-control buy_price "
                                        ...
                                        <div class="row table-responsive ">
                                            ...
                                            <table class="">
                                                <tbody id="showitem">
                                                    ...
                                                    <tr class="last-item-row sub_c">
                                                        ...
                                                        <td class="add-row">
                                                            ...
                                                            @if (in_array('Customer', $choosePermission) || auth()->user()->is_admin == '1')
                                                                <button type="button" data-toggle="modal"
                                                                    data-target="#modal-lg"
                                                                    class="mx-2 btn btn-danger">
                                                    ...
                                                    <tr class="" hidden>
                                                        ...
                                                        <!-- <td align="left" colspan="1"
                                                            class="col-md-2 exchange_rate">
                                                            <div class="input-group" >
                                                            <input type="text" name="exchange_rate"
                                                                class="form-control exchange_rate"
                                                                id="exchange_rate" placeholder="Enter Exchange Rate" disabled>
                                                ...
                                                <tr class="sub_c" style="display: table-row;">
                                                    ...
                                                    <td align="left" colspan="2"><input type="number"
    ...
    {{-- <script>
        ...
        //     fetch('{{ url('invoice_no_updates') }}?location=${location} ')
        function fetchInvoiceUpdates() {
            ...
            if (!locationId) {
                ...
                fetch("{{ url('invoice_no_updates') }}?location_id=" + encodeURIComponent(locationId))
                    .then(response => response.json()) // Directly parse JSON
                    .then(data => {
                        const invoiceNoInput = $("#invoice_no"); // Get the invoice number input
        ...
        setInterval(fetchInvoiceUpdates, 100);
    </script> --}}
        ...
        $(document).ready(function() {
            ...
            $("#addproduct").click(function(e) {
                ...
                let newRow = '<tr>' +
                    ...
                    '<td class="d-none"><input type="text" class="form-control buy_price" name="buy_price[]" id="buy_price-' +
                    count + '"   autocomplete="off"></td>' +
                    '<td><input type="text" class="form-control warranty auto_calculate" name="warranty[]" id="warranty-' +
                    count + '"   autocomplete="off"></td>' +
            ...
            function paidFunction() {
                let paid = parseFloat($('#paid').val()) || 0; // Get the paid amount or default to 0
                let total_p = parseFloat($('#total_total').val()) || 0; // Get the total amount or default to 0

                // Check if paid is greater than total_p
                if (paid > total_p) {
                    alert('Paid amount is greater than the total amount!');
                    $('#paid').val(''); // Clear the #paid input field
                    $('#balance').val(''); // Clear the #paid input field
                    return; // Exit the function to stop further execution
                } else {
                    // Calculate the balance
                    let balance = total_p - paid;
                    balance = Math.round(balance); // Round the balance

                    $('#balance').val(balance); // Update the balance input field
                }
            }
            ...
            //     let name = $("#name").val().trim(); // Get trimmed value of #name
            //     let cuz_name = $("#type").val();
            //     const row = $(this).closest('tr');

            //     if (name && !$(this).hasClass('productname')) {
            //         console.log("Calling updateCustomer with name:", name);
            //         updateCustomer(name);
            //     } else {
            //         const item_id = row.find('.item_id').val();
            //         const variation_id = row.find('.result_id').val();

            //         console.log("Calling updateItemName with:", item_id, variation_id, cuz_name);
