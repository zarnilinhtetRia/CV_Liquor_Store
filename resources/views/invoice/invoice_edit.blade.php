...
<body>
                ...
                <div class="my-3 mt-4 row">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="overdue_date" id="overdue_date" class="form-control round"
                            autocomplete="off" value="{{ $invoice->overdue_date }}">
                    </div>
                                                ...
                                                <tbody>
                                                    <tr class="item_header bg-gradient-directional-blue white">
                                                        ...
                                                        <td class="text-center" style="display: none;"><input
                                                                ...
                                                                class="form-control" value="{{ $invoice->type }}">
                                                        </td>
                                                    ...
                                                    @foreach ($sell as $key => $sell)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden"
                                                                    class="form-control size typeahead" name="size[]"
                                                                    id="size-0" value="{{ $sell->size }}">
                                                            ...
                                                            <td><input type="number"
                                                                ...
                                                                <input type="hidden" id="alert-0" value=""
                                                                    name="alert[]">
                                                                <input type="hidden" id="delivered_qty-0"
                                                            ...
                                                            {{-- <td class="foc_td">
                                                                <select class="form-control round auto_calculate foc"
                                                            ...
                                                            <td class="">
                                                                <input type="text" class="form-control warranty "
                                                                    name="warranty[]" id="warranty-0"
                                                                    autocomplete="off" value="{{ $sell->warranty }}">
                                                            </td>
                                                            <td class="retail_td">
                                                                <input type="number"
                                                            ...
                                                            @php
                                                                $amount =
                                                                    ...
                                                                    $sell->discount_amt;
                                                                $subtotal = $sell->product_qty * $sell->retail_price;
                                                            @endphp
                                                            <td style="text-align:center"><strong><span
                                                                        class='ttlText1'
                                                                        id="">{{ $amount }}</span></strong>
                                                            </td>
                                            ...
                                            <table class="mt-3">
                                                <tbody id="showitem">
                                                    ...
                                                    <tr class="sub_c" style="display: table-row;">
                                                        ...
                                                        <td align="left" colspan="2" class="col-md-4"><input
                                                                ...
                                                                data-val="{{ $item_dis }}" id="item_discount"
                                                                value="{{ $item_discount }}" readonly>
                                                        </td>
                                                ...
                                                <tr class="sub_c" style="display: table-row;">
                                                    ...
                                                    <td align="left" colspan="2"><input type="text"
                                                            ...
                                                            onchange="paidFunction()" value="{{ $invoice->deposit }}"
                                                            readonly>
                                                ...
                                                <tr class="sub_c " style="display: table-row;">
                                                    ...
                                                    <td align="right" colspan="9">
                                                        ...
                                                        <button id="submitButton" class=" mx-2 mt-3 btn btn-primary"
                                                            type="submit"
    ...
    <!-- <script>
        ...
        function getBranchInvoiceNo() {
            ...
            // let reg_mode = $("#balance_due").val();

            // console.log(warehouse_id);
            // console.log(reg_mode);

            if (warehouse_id) {
                $.ajax({
                    type: 'POST',
                    url: "{{ route('get_branch_invoice_no') }}",
                    data: {
                        _token: "{{ csrf_token() }}",
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.discount_cat', function(e) {
