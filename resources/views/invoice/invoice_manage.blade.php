                                    ...
                                    <div id="branchDropdown" class="dropdown ml-auto"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            @if (auth()->user()->is_admin == '1')
                                                <a href="{{ url('invoice') }}" class="dropdown-item">All Invoices</a>
                                                @foreach ($branchs as $drop)
                                                    <a class="dropdown-item"
                                                        href="{{ route('invoice', $drop->id) }}">{{ $drop->name }}</a>
                                                @endforeach
                                            @else
                                                @php
                                        ...
                                        @foreach ($invoices as $invoice)
                                            <tr>
                                                    ...
                                                    @if (in_array('Invoice Payment', $choosePermission) || auth()->user()->is_admin == '1')
                                                        @if ($invoice->status == 'invoice')
                                                            <a href="{{ url('make_payment', $invoice->id) }}"
                                                                class="btn btn-warning btn-md text-white mb-1"><i
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    @if ($invoice->status == 'invoice')
                                                        <a href="{{ url('/deliver', $invoice->id) }}"
                                                            class="btn btn-success btn-sm">Deliver...<i
