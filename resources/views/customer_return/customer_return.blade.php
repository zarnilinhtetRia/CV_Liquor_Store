...
<body>
        ...
        <form method="post" id="myForm" action="{{ url('invoice_register') }}" enctype="multipart/form-data">
            ...
            <div class="mx-3 row ">
                ...
                <div class="my-3 mt-4 row">
                    <div class="col-md-3">
                        <label for="invoice_no" style="font-weight:bolder">Return Number <span
                    ...
                    {{-- <div class="col-md-3">
                        <label for="branch_invoice_no" style="font-weight:bolder">Branch Customer Return
                            Number</label>
                                        ...
                                        <div class="mt-1 row table-responsive ">
                                                ...
                                                <tbody>
                                                    <tr class="item_header bg-gradient-directional-blue white">
                                                        ...
                                                        <input type='hidden' name='status' id="status"
                                                            class="form-control" value="customer return">
                                            ...
                                            {{-- <div class="mt-4 frmSearch col-md-3">
                                                <label for="exchange_rate"
                                                    style="font-weight:bolder">{{ trans('Exchange Rate') }} <span
                                                        class="text-danger fw-bold">*</span>
                                                </label>

                                                <div class="input-group">
                                                    <input type="text"
                                                        name="exchange_rate"class="form-control exchange_rate"
                                                        id="exchange_rate" placeholder="Enter Exchange Rate" required>
                                            ...
                                            <table class="mt-3">
                                                        ...
                                                        <td class="add-row">
                                                            ...
                                                            @if (in_array('Item', $choosePermission) || auth()->user()->is_admin == '1')
                                                                <a href="{{ URL('items') }}" target="_blank"
                                                                    ...
                                                                    <button type="button" class="btn btn-danger">
                                                                        <i
                                                                            class="fa-solid fa-magnifying-glass-plus"></i></i>
                                                                        Product
                                                                        Search
                                                                    </button></a>
                                                            @endif
                                                ...
                                                <tr class="sub_c " style="display: table-row;">
                                                    ...
                                                    <td align="right" colspan="9">
                                                        ...
                                                        <button id="submitButton" class="mx-3 mt-3 btn btn-primary"
                                                            type="submit"
    ...
    {{-- <script>
        ...
        function fetchInvoiceUpdates() {
            const branch = $('#location').val(); // Assuming you have a branch input or select with id 'branch'

            fetch("{{ url('customer_return_no_updates') }}?branch=" + branch)
        ...
        $(document).ready(function() {
                ...
                $('#productname-' + count).typeahead({
                    source: function(query, process) {
                        if ($('#exchange_rate').val() == '') {
                            alert('Please fill in the Exchange Rate field first!');
                            return false;
                        } else {
                    ...
                    displayText: function(item) {
                        return item.display; // Show both item_name and model in the suggestion
                    },
            ...
            $("#addproduct").click(function(e) {
                ...
                let newRow = '<tr>' +
                    ...
                    count +
                    '" autocomplete="off"><input type="hidden" class="form-control result_product_code typeahead" name="result_product_code[]" id="result_product_code-' +
                    count +
                    ...
                    '<td class="retail_td"><input type="text" class="form-control retail_price auto_calculate" name="retail_price[]" value="0" id="retail_price-' +
                    count + '"   autocomplete="off" ></td>' +
