            ...
            <section class="content">
                ...
                <div class="ml-2 container-fluid">
                    ...
                    <div class="my-5 container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ url('purchase_product_search') }}" method="get">
                                    <div class="row">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($purchases as $purchase)
                                                <tr>
                                                    <td>{{ $no++ }}</td>
                                                    <td> <a href="{{ url('supplier_items', ['id' => $purchase->supplier_id, 'start_date' => $start_date, 'end_date' => $end_date]) }}">{{ $purchase->supplier ? $purchase->supplier->name : '' }}</a> </td>
